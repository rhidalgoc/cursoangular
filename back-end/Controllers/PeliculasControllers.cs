...
namespace back_end.Controllers
{
    ...
    public class PeliculasControllers:ControllerBase
    {
        ...
        public PeliculasControllers(ApplicationDbContext context, IMapper mapper, IAlmacenadorArchivos almacenadorArchivos)
        {
        ...
        {
            if(pelicula.PeliculasAcores != null)
            {
                for(int i = 0; i < pelicula.PeliculasAcores.Count; i++)
                {
                    pelicula.PeliculasAcores[i].Orden = i;
                }
            }
        }
